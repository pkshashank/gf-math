...
/* package GFLeanTransfer-0.1 */
#ifndef VERSION_GFLeanTransfer
#define VERSION_GFLeanTransfer "0.1"
#endif /* VERSION_GFLeanTransfer */
#ifndef MIN_VERSION_GFLeanTransfer
#define MIN_VERSION_GFLeanTransfer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_GFLeanTransfer */
...
#define CURRENT_COMPONENT_ID "GFLeanTransfer-0.1-GFbWFi1PCIFH3HJgVuxM3C-Translate"
